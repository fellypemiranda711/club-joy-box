...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vision Club — Clube de assinatura de lentes de grau" },
      {
        name: "description",
        content:
          "Assinatura anual com condições exclusivas em lentes de grau, negociadas com laboratórios parceiros.",
      },
      { name: "author", content: "Vision Club" },
